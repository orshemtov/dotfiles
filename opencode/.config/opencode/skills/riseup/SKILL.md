...
Query your personal finance data from [RiseUp](https://input.riseup.co.il) (Israeli personal finance app) directly through your favorite agent (Claude, Opencode, Copilot, Codex).
