...
version: "1.3.0"
description: >
  Use this skill when the user wants direct interaction with an Obsidian vault:
  reading, creating, writing, appending, searching, counting, listing, moving,
  renaming, deleting, or organizing notes; managing tasks, backlinks, orphaned
  notes, broken links, properties, bookmarks, sync history, Bases, file history,
  or JavaScript automation through the Obsidian API. Trigger when the request
  implies acting inside the vault, not explaining Obsidian concepts. Skip for
  pure GUI, settings, theme/plugin installation, sync-conflict, Dataview syntax,
  shortcut, or external-file-parsing explanations.
triggers:
  - "obsidian"
  - "vault"
  - "daily note"
